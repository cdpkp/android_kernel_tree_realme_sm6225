...
TYPE_C_ATTR(current_det, "%u\n")
TYPE_C_ATTR(accessory_attach, "%u\n")
TYPE_C_ATTR(active_cable_attach, "%u\n")
TYPE_C_ATTR(attach_state, "%u\n")
TYPE_C_ATTR(cable_dir, "%u\n")
...
static void process_interrupt_register(struct sgm7220_info *info)
{
	...
	pr_debug("%s chg_init_one[%d] attach[%d] cabledir[%d] probe[%d]\n", __func__, chg_init_done,
...
late_initcall(sgm7220_i2c_init);
