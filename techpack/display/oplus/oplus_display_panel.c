...
static const struct panel_ioctl_desc panel_ioctls[] = {
	...
	PANEL_IOCTL_DEF(PANEL_IOCTL_GET_LOG_TYPE, oplus_display_panel_get_dsi_log_switch),
	PANEL_IOCTL_DEF(PANEL_IOCTL_SET_LOG_TYPE, oplus_display_panel_set_dsi_log_switch),
	...
	PANEL_IOCTL_DEF(PANEL_IOCTL_SET_FRAMEDONW_IDLE_ENABLE, oplus_display_panel_set_framedone_idle),
